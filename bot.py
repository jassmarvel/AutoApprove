...
gif = [
    'https://telegra.ph/file/4176f69dda709ba1df6e2.mp4'
]
...
async def approve(_, m : Message):
    ...
    try:
        ...
        await app.send_video(kk.id,img, "**ʜᴇʟʟᴏ {}!\nᴡᴇʟᴄᴏᴍᴇ ᴛᴏ {}\n\n__ᴘᴏᴡᴇʀᴇᴅ ʙʏ : @Ethical_botz**".format(m.from_user.mention, m.chat.title))
        add_user(kk.id)
            ...
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton("sᴜᴘᴘᴏʀᴛ", url="https://t.me/Ethical_botz")
                    ],[
